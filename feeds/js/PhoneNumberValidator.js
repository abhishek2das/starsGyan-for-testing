...
*/
  ...
  function La(a, b) {
    for (var c = Ha(a.m()), d = 0; d < c.length; d++) {
      var f = c[d],
        e = f.g;
      if (p(b, e)) {
        a.g && delete a.g[f.g];
        ...
        if (f.j) {
          f = v(b, e);
          for (var h = 0; h < f.length; h++) Ka(a, e, g ? f[h].clone() : f[h]);
        } else
          (f = Ta(b, e)),
            g ? ((g = Ta(a, e)) ? La(g, f) : t(a, e, f.clone())) : t(a, e, f);
      }
    }
  }
  n.prototype.clone = function () {
    var a = new this.constructor();
    a != this && ((a.h = {}), a.g && (a.g = {}), La(a, this));
    return a;
  };
  function p(a, b) {
    return null != a.h[b];
  ...
  function Ta(a, b) {
    ...
    if (a.l) {
      if (!(b in a.g)) {
        ...
        if (null != c)
          if (f.j) {
            for (var e = [], g = 0; g < c.length; g++) e[g] = d.g(f, c[g]);
            c = e;
          } else c = d.g(f, c);
        return (a.g[b] = c);
      }
  ...
  function r(a, b, c) {
    var d = Ta(a, b);
    return a.j[b].j ? d[c || 0] : d;
  }
  function w(a, b) {
    if (p(a, b)) a = r(a, b, void 0);
    else
      a: {
        a = a.j[b];
        if (void 0 === a.l)
  ...
  function x(a, b) {
    return a.j[b].j ? (p(a, b) ? a.h[b].length : 0) : p(a, b) ? 1 : 0;
  }
  function t(a, b, c) {
    a.h[b] = c;
    a.g && (a.g[b] = c);
  ...
  function Va(a, b) {
    var c = [],
      d;
    for (d in b) 0 != d && c.push(new ya(d, b[d]));
    return new Ga(a, c);
  }
  function y() {}
  ...
  y.prototype.g = function (a, b) {
    if (11 == a.h || 10 == a.h)
      return b instanceof n ? b : this.j(a.u.prototype.m(), b);
    if (14 == a.h)
      return "string" === typeof b && Wa.test(b) && ((a = Number(b)), 0 < a)
        ? a
        : b;
    if (!a.s) return b;
    a = a.u;
    if (a === String) {
      ...
      a === Number &&
      "string" === typeof b &&
      ("Infinity" === b || "-Infinity" === b || "NaN" === b || Wa.test(b))
    )
      return Number(b);
    return b;
  };
  ...
  A.prototype.l = function (a) {
    for (var b = Ha(a.m()), c = {}, d = 0; d < b.length; d++) {
      var f = b[d],
        e = f.g;
      switch (this.s) {
        case 1:
          ...
          break;
        case 2:
          e = sa(f.o.replace(/_/g, "-"));
      }
      if (a.has(f))
        if (f.j) {
          var g = [];
          c[e] = g;
          for (e = 0; e < x(a, f.g); e++) g.push(this.h(f, a.get(f, e)));
        } else c[e] = this.h(f, a.get(f));
    }
    Ja(a, function (h, m) {
      c[h] = m;
    });
  ...
  A.prototype.h = function (a, b) {
    return this.v && 8 == a.h && "boolean" === typeof b
      ? b
        ? 1
        : 0
      : A.la.h.call(this, a, b);
  };
  A.prototype.g = function (a, b) {
    return 8 == a.h && "number" === typeof b ? !!b : A.la.g.call(this, a, b);
  };
  A.prototype.o = function (a, b) {
    ...
    for (d in b) {
      var f = b[d],
        e = !/[^0-9]/.test(d);
      if (e) var g = c.g[parseInt(d, 10)] || null;
      else
        2 == this.s &&
          (d = String(d)
            .replace(/([A-Z])/g, "-$1")
          ...
          (g = Ia(c, d));
      if (g)
        if (g.j) for (e = 0; e < f.length; e++) a.add(g, this.g(g, f[e]));
        else a.set(g, this.g(g, f));
      else
        e
          ? ((g = a), (e = Number(d)), (g.h[e] = f), g.g && delete g.g[e])
          : this.u || na("Failed to find field: " + d);
    }
  };
  function B(a, b) {
...
*/
    ...
    a ||
      (Za = a =
        Va(F, {
          ...
          19: { name: "number_format", aa: !0, i: 11, type: D },
          20: { name: "intl_number_format", aa: !0, i: 11, type: D },
          22: {
  ...
  G.prototype.l = function (a) {
    for (var b = Ha(a.m()), c = [], d = 0; d < b.length; d++) {
      ...
      if (a.has(f)) {
        ...
        if (f.j) {
          c[e] = [];
          for (var g = 0; g < x(a, f.g); g++) c[e][g] = this.h(f, a.get(f, g));
        } else c[e] = this.h(f, a.get(f));
      }
    }
    Ja(a, function (h, m) {
  ...
  G.prototype.h = function (a, b) {
    return 8 == a.h ? (b ? 1 : 0) : y.prototype.h.apply(this, arguments);
  };
  G.prototype.g = function (a, b) {
    return 8 == a.h ? !!b : y.prototype.g.apply(this, arguments);
  };
  G.prototype.j = function (a, b) {
    return G.la.j.call(this, a, b);
  };
  function H() {
    n.call(this);
  }
    ...
    a ||
      (ab = a =
        Va(H, {
          ...
          6: { name: "country_code_source", i: 14, defaultValue: 0, type: bb },
...
*/
  ...
  var ob = new RegExp("(?:" + nb() + ")$", "i"),
    ...
    ub = /^\(?\$1\)?$/;
  function vb(a) {
    return 2 > a.length ? !1 : M(pb, a);
  }
  function wb(a) {
    return M(mb, a) ? N(a, fb) : N(a, J);
  }
  function xb(a) {
    var b = wb(a.toString());
    C(a);
  ...
  function zb(a) {
    return 0 == a.length || ub.test(a);
  }
  function Ab(a) {
    return null != a && isNaN(a) && a.toUpperCase() in cb;
  }
  function O(a, b, c) {
    if (0 == r(b, 2) && p(b, 5)) {
      var d = w(b, 5);
  ...
  function Eb(a, b, c) {
    if (!Ab(c)) return O(a, b, 1);
    var d = w(b, 1),
      f = P(b);
    if (!(d in I)) return f;
    if (1 == d) {
      if (null != c && I[1].includes(c.toUpperCase()))
        return d + " " + O(a, b, 2);
    } else if (d == Fb(a, c)) return O(a, b, 2);
    var e = S(a, c),
      g = w(e, 11);
    c = "";
    p(e, 17) ? (c = w(e, 17)) : M(gb, g) && (c = g);
    a = Q(a, d, R(d));
    f = Db(f, a, 1);
    b = Cb(b, a, 1);
    return 0 < c.length ? c + " " + d + " " + f + b : Bb(d, 1, f, b);
  }
  function P(a) {
    if (!p(a, 2)) return "";
    var b = "" + r(a, 2);
    return p(a, 4) && r(a, 4) && 0 < w(a, 8)
  ...
  function Db(a, b, c, d) {
    ...
    b = Gb(b, a);
    return null == b ? a : Hb(a, b, c, d);
  }
  function Gb(a, b) {
    for (var c, d = a.length, f = 0; f < d; ++f) {
      c = a[f];
      var e = x(c, 3);
      if (0 == e || 0 == b.search(r(c, 3, e - 1)))
        if (((e = new RegExp(r(c, 1))), M(e, b))) return c;
    }
    return null;
  }
  function Hb(a, b, c, d) {
    ...
    2 == c && null != d && 0 < d.length && 0 < g.length
      ? ((b = g.replace(tb, d)), (f = f.replace(qb, b)), (a = a.replace(e, f)))
      : ((b = w(b, 4)),
        (a =
          2 == c && null != b && 0 < b.length
            ? a.replace(e, f.replace(qb, b))
            : a.replace(e, f)));
    3 == c &&
      ((a = a.replace(
        /^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/,
  ...
  function T(a, b) {
    var c = a.length;
    return 0 < x(b, 9) && -1 == v(b, 9).indexOf(c) ? !1 : M(w(b, 2), a);
  }
  function fc(a, b) {
    var c = gc(a, b);
    return hc(a, b, c);
  ...
  function hc(a, b, c) {
    var d = w(b, 1),
      f = Q(a, d, c);
    if (null == f || ("001" != c && d != Fb(a, c))) return !1;
    a = P(b);
    return -1 != ec(a, f);
  }
  function gc(a, b) {
  ...
  function ic(a, b, c, d) {
    var f = Ib(c, d),
      e = 0 == x(f, 9) ? v(r(c, 1), 9) : v(f, 9);
    f = v(f, 10);
    if (2 == d)
      if (yb(Ib(c, 0)))
        (a = Ib(c, 1)),
          yb(a) &&
            ((e = e.concat(0 == x(a, 9) ? v(r(c, 1), 9) : v(a, 9))),
            e.sort(),
            0 == f.length
              ? (f = v(a, 10))
              : ((f = f.concat(v(a, 10))), f.sort()));
      else return ic(a, b, c, 1);
    if (-1 == e[0]) return 5;
    b = b.length;
  ...
  function lc(a, b, c, d, f, e) {
    ...
    var h = b.toString();
    if (0 == h.length) g = 20;
    else if (K.test(h)) (h = h.replace(K, "")), C(b), b.g(wb(h)), (g = 1);
    else {
      h = new RegExp(g);
      xb(b);
      g = b.toString();
      if (0 == g.search(h)) {
        ...
        var m = g.substring(h).match(ib);
        m && null != m[1] && 0 < m[1].length && "0" == N(m[1], J)
          ? (g = !1)
    ...
    if (
      ...
      (m = b.toString()),
      0 == m.lastIndexOf(h, 0) &&
        ((h = new B(m.substring(h.length))),
        (m = r(c, 1)),
        (m = new RegExp(w(m, 2))),
        mc(h, c, null),
        (h = h.toString()),
        (!M(m, b.toString()) && M(m, h)) || 3 == ic(a, b.toString(), c, -1)))
    )
      return d.g(h), f && t(e, 6, 10), t(e, 1, g), g;
    t(e, 1, 0);
    return 0;
  }
  function mc(a, b, c) {
    ...
    if (0 != f && null != e && 0 != e.length) {
      ...
      if ((f = g.exec(d))) {
        ...
        var h = M(e, d),
          m = f.length - 1;
        b = r(b, 16);
        if (null == b || 0 == b.length || null == f[m] || 0 == f[m].length) {
          if (!h || M(e, d.substring(f[0].length)))
            null != c && 0 < m && null != f[m] && c.g(f[1]),
              a.set(d.substring(f[0].length));
        } else if (((d = d.replace(g, b)), !h || M(e, d)))
          null != c && 0 < m && c.g(f[1]), a.set(d);
      }
    }
  }
  function nc(a, b, c, d) {
    ...
    if (0 <= e) {
      ...
      if ("+" == b.charAt(g)) {
        var h = b.indexOf(";", g);
        0 < h ? f.g(b.substring(g, h)) : f.g(b.substring(g));
      }
      g = b.indexOf("tel:");
      f.g(b.substring(0 <= g ? g + 4 : 0, e));
    } else
      (e = f.g),
        (g = b.search(jb)),
        0 <= g
    ...
    if (!vb(f.toString()))
      throw Error("The string supplied did not seem to be a phone number");
    e = f.toString();
    if (!(Ab(c) || (null != e && 0 < e.length && K.test(e))))
      throw Error("Invalid country calling code");
    e = new H();
    d && t(e, 5, b);
    a: {
      b = f.toString();
      g = b.search(ob);
      if (0 <= g && vb(b.substring(0, g))) {
        h = b.match(ob);
        for (var m = h.length, u = 1; u < m; ++u)
    ...
    try {
      ...
      if ("Invalid country calling code" == q.message && K.test(m)) {
        if (((m = m.replace(K, "")), (h = lc(a, m, g, b, d, e)), 0 == h))
          throw q;
      } else throw q;
    }
    0 != h
      ...
      : (xb(f),
        b.g(f.toString()),
        null != c ? ((h = w(g, 10)), t(e, 1, h)) : d && Ua(e, 6));
    if (2 > b.h.length)
    ...
    null != g &&
      ...
      (f = new B(b.toString())),
      mc(f, g, c),
      (a = ic(a, f.toString(), g, -1)),
      2 != a &&
        4 != a &&
        5 != a &&
        ((b = f), d && 0 < c.toString().length && t(e, 7, c.toString())));
    d = b.toString();
    a = d.length;
    if (2 > a)
      throw Error("The string supplied is too short to be a phone number");
  ...
  function tc(a) {
    for (var b = a.j.length, c = 0; c < b; ++c) {
      ...
      u.length < m.g.h.length
        ? (m = "")
        : ((m = u.replace(new RegExp(h, "g"), g)),
          (m = m.replace(/9/g, "\u2008")));
      0 < m.length ? (e.v.g(m), (e = !0)) : (e = !1);
      if (e) return (a.da = f), (a.ha = sc.test(r(d, 4))), (a.$ = 0), !0;
    }
    return (a.u = !1);
  }
  function uc(a, b) {
  ...
  function vc(a, b) {
    a.s.g(b);
    var c = b;
    ib.test(c) || (1 == a.s.h.length && hb.test(c))
      ? ("+" == b ? ((c = b), a.ba.g(b)) : ((c = J[b]), a.ba.g(c), a.g.g(c)),
        (b = c))
      : ((a.u = !1), (a.oa = !0));
    if (!a.u) {
      if (!a.oa)
    ...
    switch (a.ba.h.length) {
      ...
      case 3:
        if (wc(a)) a.ea = !0;
        else return (a.o = zc(a)), Ac(a);
      default:
        if (a.ea) return xc(a) && (a.ea = !1), a.h.toString() + a.g.toString();
        if (0 < a.j.length) {
          b = Bc(a, b);
          c = Cc(a);
          if (0 < c.length) return c;
          uc(a, a.g.toString());
          return tc(a) ? Dc(a) : a.u ? Ec(a, b) : a.s.toString();
        }
        return Ac(a);
    }
  }
  ...
  function Cc(a) {
    for (var b = a.g.toString(), c = a.j.length, d = 0; d < c; ++d) {
      ...
      if (
        new RegExp("^(?:" + e + ")$").test(b) &&
        ((a.ha = sc.test(r(f, 4))),
        (f = b.replace(new RegExp(e, "g"), r(f, 2))),
        (f = Ec(a, f)),
        N(f, eb) == a.ba)
      )
        return f;
  ...
  function Ac(a) {
    ...
    if (3 <= b.length) {
      for (
        var c =
            a.ca && 0 == a.o.length && 0 < x(a.l, 20) ? v(a.l, 20) : v(a.l, 19),
          d = c.length,
          f = 0;
        f < d;
        ++f
        ...
        var e = c[f];
        (0 < a.o.length && zb(w(e, 4)) && !r(e, 6) && !p(e, 5)) ||
          ((0 != a.o.length || a.ca || zb(w(e, 4)) || r(e, 6)) &&
            rc.test(w(e, 2)) &&
            a.j.push(e));
      }
      uc(a, b);
      b = Cc(a);
      return 0 < b.length ? b : tc(a) ? Dc(a) : a.s.toString();
    }
    return Ec(a, b);
  }
  function Dc(a) {
    var b = a.g.toString(),
      c = b.length;
    if (0 < c) {
      for (var d = "", f = 0; f < c; f++) d = Bc(a, b.charAt(f));
      return a.u ? Ec(a, d) : a.s.toString();
    }
    return a.h.toString();
  }
  function zc(a) {
  ...
  function xc(a) {
    ...
    a.g.g(b.toString());
    b = R(c);
    "001" == b ? (a.l = S(a.ga, "" + c)) : b != a.na && (a.l = pc(a, b));
    a.h.g("" + c).g(" ");
    a.o = "";
    return !0;
  }
  ...
  var Fc = {
    ...
    AT: [
      ...
      [
        ,
        ,
        "116(?:00[06]|1(?:17|23))|(?:61|8108[1-3])0|1(?:[12]2|33|44)",
        ,
        ,
        ,
        "112",
    ...
    CH: [
      ...
      [
        ,
        ,
        "1(?:0[78]\\d\\d|1(?:[278]|45|6(?:000|111))|4(?:[03-57]|1[45])|6(?:00|[1-46])|8(?:02|1[189]|50|7|8[08]|99))|[2-9]\\d{2,4}",
        ,
        ,
        ,
        "112",
    ...
    CZ: [
      ...
      [
        ,
        ,
        "1(?:1(?:2|8\\d)|(?:2|3\\d)\\d{2,3}|5[0568]|99)|1(?:16|4)\\d{3}",
        ,
        ,
        ,
        "112",
    ...
    DK: [
      ...
      [
        ,
        ,
        "1(?:1(?:[2-48]|6(?:00[06]|111))|8(?:[08]1|1[0238]|28|30|5[13]))",
        ,
        ,
        ,
        "112",
    ...
    FR: [
      ...
      [
        ,
        ,
        "10(?:[134]4|2[23]|5\\d|99)|202\\d|3(?:646|9[07]0)|634|70[06]|(?:106|61)[14]",
        ,
        ,
        ,
        "611",
    ...
    SC: [
      ...
      [
        ,
        ,
        "1(?:[06]\\d|1[0-2467]|2[0-8]|3[13]|4[0-2]|[59][15]|7[124-6]|8[158])|9(?:6\\d\\d|99)",
        ,
        ,
        ,
        "100",
...
*/
  ...
  function Oc(elmHtml) {
    ...
    var a = elmHtml,
      b = 'IN',
      // xa("defaultCountry").value.toUpperCase()
      // c = xa("carrierCode").value,
      d = new B();
    try {
      var f = X;
      if (!Ab(b) && 0 < a.length && "+" != a.charAt(0))
        throw Error("Invalid country calling code");
      var e = nc(f, a, b, !0);
      d.g("****Parsing Result:****\n");
      d.g(JSON.stringify(new A(1).l(e)));
      d.g("\n\n****Validation Results:****");
      var g = jc(e);
      var h = 0 == g || 4 == g;
      ...
      if (h)
        if (4 == m)
          ...
          d.g(u);
          // console.log(JSON.parse(JSON.stringify(d.g(u))))
          value1 = JSON.stringify(d.g(u))
          array1 = value1.split("isValidNumber():")
          
          u &&
            f &&
            (d.g("\nResult from isValidNumberForRegion(): "), d.g(hc(X, e, b)));
          d.g("\nPhone Number region: ");
          d.g(gc(X, e));
      ...
      if (!u) {
        ...
        a: {
          var Jb = Hc(w(e, 1)),
            Qc = Lc(e).length;
          for (h = 0; h < Jb.length; h++) {
            var Kb = Kc(q, Jb[h]);
            if (Kb && v(r(Kb, 1), 9).includes(Qc)) {
              var Lb = !0;
              break a;
            }
          }
        ...
        var Rc = d.g,
          U = Hc(w(e, 1));
        a: if (0 === U.length) var ca = null;
        else if (1 === U.length) ca = U[0];
        else {
          var Sc = Lc(e);
          for (ba = 0; ba < U.length; ba++) {
            var Mb = U[ba],
              Nb = Kc(q, Mb);
            if (Nb && Mc(Sc, r(Nb, 29))) {
              ca = Mb;
        ...
        var Tc = 1 < U.length && null != ca ? !0 : Jc(q, e, ca);
        Rc.call(d, Tc);
        if (f) {
      ...
      if (V) var Na = w(e, 5);
        ...
        switch (r(e, 6)) {
          ...
          case 5:
            ...
            break;
          case 10:
            z = O(q, e, 1).substring(1);
            break;
          default:
            var da = R(w(e, 1));
            var Sb = S(q, da);
            if (null == Sb) var ea = null;
            else {
              var Oa = w(Sb, 12);
              ea = 0 == Oa.length ? null : (Oa = Oa.replace("~", ""));
            }
            var fa = O(q, e, 2);
            if (null == ea || 0 == ea.length) z = fa;
            else {
              b: {
                var Yc = w(e, 5);
                V = ea;
                var Tb = N(Yc, J);
                if (0 == Tb.lastIndexOf(V, 0))
                  try {
                    var Ub = fc(q, nc(q, Tb.substring(V.length), da, !1));
                    break b;
                  } catch (Vb) {}
                Ub = !1;
              }
              if (Ub) z = fa;
                ...
                if (null == Pa) z = fa;
                  ...
                  if (0 >= Wb) z = fa;
                    ...
                    ((W = W.substring(0, Wb)), (W = N(W, J)), 0 == W.length)
                  )
                    z = fa;
                  else {
                    var Xb = Pa.clone();
                    ...
                    if (ta in I) {
                      ...
                      if (null == Qa) var Zb = ua;
                        ...
                        if (0 < va.length) {
                          var $b = w(Yb, 12);
                          0 < $b.length
                            ? ((va = va.replace(rb, $b).replace(sb, "$1")),
                              t(Ra, 4, va))
                            : Ua(Ra, 4);
                        }
                        Zb = Hb(ua, Ra, 2);
      ...
      d.g(u ? O(X, e, 1) : "invalid");
      d.g("\nOut-of-country format from US: ");
      d.g(u ? Eb(X, e, "US") : "invalid");
      d.g("\nOut-of-country format from Switzerland: ");
      d.g(u ? Eb(X, e, "CH") : "invalid");
      if (0 < c.length) {
    ...
    OutputValue = d.toString();
    // console.log( d.toString())
    checkNumber = OutputValue.match(/mobile/gi)
    //  console.log(checkNumber)
    //  console.log(realMobileNumber)
      
    // textChanges = elmHtml.replace(realMobileNumber,"+91xxxxxxxxxx")
     if(checkNumber === null){
      OutputValue = ""
      checkNumber= []
      return false
  ...
  var Pc = ["phoneNumberParser"],
    Y = ka;
  Pc[0] in Y ||
    "undefined" == typeof Y.execScript ||
    Y.execScript("var " + Pc[0]);
  for (var Z; Pc.length && (Z = Pc.shift()); )
    Pc.length || void 0 === Oc
